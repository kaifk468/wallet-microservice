...
@CrossOrigin
@RestController
@RequestMapping("wallet-merchant-transfer")
public class WalletToMerchantTransferController {
	@Autowired
	...
	static Logger logger = LogManager.getLogger(WalletToMerchantTransferController.class.getName());
	...
	//It will give list of Merchants based on thier Type
