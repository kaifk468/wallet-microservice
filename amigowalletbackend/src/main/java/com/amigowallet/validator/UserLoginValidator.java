...
public class UserLoginValidator {
	 ...
	 */
	public static void validateUserLogin(UserDto userDto)
			throws Exception {
		
		/* here we are checking for valid email id format */
		if (!validateUserEmail(userDto.getEmailId())) {
			throw new Exception(
	 ...
	 */
	public static void validateChangePasswordDetails(UserDto userDto)
			throws Exception			
	{
		if (!validatePassword(userDto.getPassword())) {
			throw new Exception(
		...
		if (!validatePassword(userDto.getConfirmNewPassword())) {
			throw new Exception(
